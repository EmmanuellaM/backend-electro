...
public class PatientController {
    ...
    public ResponseEntity<List<PatientResponseDTO>> getAllPatients(
        ...
        List<Parametres> allParametres = parametresRepository.findAll();

        // Grouper par identifiantPatient et prendre le plus récent pour chaque patient
        Map<String, Parametres> latestByPatient = new LinkedHashMap<>();
        ...
        allParametres.stream()
                ...
                .forEach(p -> latestByPatient.putIfAbsent(p.getIdentifiantPatient(), p));

        List<PatientResponseDTO> patients = latestByPatient.values().stream()
