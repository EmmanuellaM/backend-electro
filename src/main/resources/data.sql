...
-- 5. PARAMETRES
INSERT INTO parametres (identifiant_patient, poids_patient, taille_patient, age_patient, temperature, pression_arterielle_systolique, pression_arterielle_diastolique, frequence_foetale, frequence_cardiaque_mere, glycemie, saturation_oxygene, date_dernieres_regles, date_mesure, statut, id_dispositif) VALUES
-- PAT-YDE-001 (Patient 1) - Profil Stable / Normal
('A840411AB22C33D1-PAT-YDE-001', 72.5, 165.0, 26, 37.1, 118, 78, 142, 82, 0.92, 98, '2025-08-10', NOW() - INTERVAL '30 minutes', 'en_attente', 1), -- ID 1
('A840411AB22C33D1-PAT-YDE-001', 72.3, 165.0, 26, 36.8, 115, 75, 140, 80, 0.90, 97, '2025-08-10', NOW() - INTERVAL '1 day', 'archive', 1),        -- ID 2
('A840411AB22C33D1-PAT-YDE-001', 72.0, 165.0, 26, 37.0, 112, 72, 138, 78, 0.88, 98, '2025-08-10', NOW() - INTERVAL '2 days', 'archive', 1),       -- ID 3
('A840411AB22C33D1-PAT-YDE-001', 71.8, 165.0, 26, 36.9, 114, 74, 139, 81, 0.87, 97, '2025-08-10', NOW() - INTERVAL '3 days', 'archive', 1),       -- ID 4
('A840411AB22C33D1-PAT-YDE-001', 71.5, 165.0, 26, 37.0, 110, 70, 137, 79, 0.85, 98, '2025-08-10', NOW() - INTERVAL '4 days', 'archive', 1),       -- ID 5

-- PAT-YDE-002 (Patient 2) - Profil Dégradation (Pré-éclampsie + Fièvre)
('A840411AB22C33D1-PAT-YDE-002', 65.0, 160.0, 22, 38.6, 150, 98, 165, 110, 1.15, 94, '2025-09-15', NOW() - INTERVAL '2 hours', 'en_attente', 1),    -- ID 6
('A840411AB22C33D1-PAT-YDE-002', 64.8, 160.0, 22, 37.9, 142, 92, 158, 105, 1.10, 95, '2025-09-15', NOW() - INTERVAL '6 hours', 'archive', 1),       -- ID 7
('A840411AB22C33D1-PAT-YDE-002', 64.5, 160.0, 22, 37.2, 135, 90, 150, 98, 1.05, 96, '2025-09-15', NOW() - INTERVAL '12 hours', 'archive', 1),      -- ID 8
('A840411AB22C33D1-PAT-YDE-002', 64.3, 160.0, 22, 37.0, 125, 82, 145, 92, 0.98, 97, '2025-09-15', NOW() - INTERVAL '1 day', 'archive', 1),         -- ID 9
('A840411AB22C33D1-PAT-YDE-002', 64.0, 160.0, 22, 36.8, 120, 80, 142, 88, 0.95, 98, '2025-09-15', NOW() - INTERVAL '2 days', 'archive', 1),        -- ID 10

-- PAT-YDE-003 (Patient 3) - Profil Fluctuant léger
('A840411AB22C33D1-PAT-YDE-003', 80.2, 170.0, 31, 36.9, 120, 80, 140, 85, 0.89, 97, '2025-07-20', NOW() - INTERVAL '3 hours', 'diagnostique', 1),  -- ID 11
('A840411AB22C33D1-PAT-YDE-003', 80.0, 170.0, 31, 37.1, 125, 82, 145, 92, 0.95, 96, '2025-07-20', NOW() - INTERVAL '1 day', 'archive', 1),         -- ID 12
('A840411AB22C33D1-PAT-YDE-003', 79.8, 170.0, 31, 36.7, 118, 78, 138, 88, 0.91, 98, '2025-07-20', NOW() - INTERVAL '2 days', 'archive', 1),        -- ID 13
('A840411AB22C33D1-PAT-YDE-003', 79.5, 170.0, 31, 37.0, 122, 80, 142, 90, 0.93, 97, '2025-07-20', NOW() - INTERVAL '3 days', 'archive', 1),        -- ID 14

('A840411AB22C33D2-PAT-EFL-001', 68.4, 162.0, 25, 37.0, 110, 70, 138, 82, 0.85, 99, '2025-10-05', NOW() - INTERVAL '5 hours', 'diagnostique', 2),  -- ID 15
('A840411AB22C33D2-PAT-EFL-002', 76.0, 168.0, 29, 37.5, 135, 90, 155, 95, 1.05, 96, '2025-08-25', NOW() - INTERVAL '1 day', 'diagnostique', 2),     -- ID 16
('A840411AB22C33D1-PAT-YDE-004', 62.1, 158.0, 23, 37.2, 115, 75, 145, 88, 0.90, 98, '2025-11-12', NOW() - INTERVAL '2 days', 'archive', 1),        -- ID 17
('A840411AB22C33D2-PAT-EFL-003', 85.5, 175.0, 34, 39.1, 160, 105, 172, 115, 1.30, 93, '2025-09-01', NOW() - INTERVAL '1 day', 'en_attente', 2),     -- ID 18
('A840411AB22C33D1-PAT-YDE-005', 70.0, 164.0, 27, 36.8, 122, 82, 148, 86, 0.98, 97, '2025-10-20', NOW() - INTERVAL '4 days', 'diagnostique', 1);   -- ID 19
...
-- 9. FEEDBACK IA
INSERT INTO feedback_ia (age_patient, poids_patient, taille_patient, temperature, pression_systolique, pression_diastolique, frequence_foetale, frequence_cardiaque_mere, glycemie, classe_predite, score_confiance, note_medecin, commentaire_medecin, id_medecin, id_parametres) VALUES
(31, 80.2, 170.0, 36.9, 120, 80, 140, 85, 0.89, 'normal', 0.95, 5, 'Prédiction IA parfaitement en accord avec mon diagnostic.', 1, 11);
